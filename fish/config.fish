...
# === variables === #
#		    #
set -gx PATH /Volumes/Samsung_T5/home_dir/homebrew/bin /Volumes/Samsung_T5/home_dir/homebrew/sbin $HOME/.config/coc/extensions/node_modules $HOME/.cargo/bin $HOME/.config/coc/extensions/coc-clangd-data/install/12.0.0/clangd_12.0.0/bin $PATH
